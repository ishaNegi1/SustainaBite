...
function Card() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:my-20 my-16">
      <h1 className="text-[#133221] dark:text-white font-Nunito font-bold text-3xl text-center">
        Our Services
      </h1>
      <div className="grid sm:grid-cols-4 grid-cols-1 sm:gap-y-6 sm:gap-x-10 gap-14 sm:mb-24 sm:my-10 my-7 px-5">
