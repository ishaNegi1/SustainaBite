  ...
  return (
    <>
      ...
      <div className=" sm:w-[70%] mx-1">
        <p className=" font-Telex sm:text-2xl lg:text-3xl text-3xl font-medium lg:mb-7 mb-7 sm:mb-4">
          Create Account
        </p>
        <form
        ...
        >
          <label htmlFor="fullname" className="mb-2 sm:text-md lg:text-lg text-lg">
            Full Name
          </label>
          <input
            type="text"
          ...
          />
          <label htmlFor="email" className=" sm:text-md text-lg mb-2">
            Email Address
          </label>
          <input
            type="email"
          ...
          <label htmlFor="password" className=" sm:text-md text-lg mb-2">
            Password
          </label>
          <input
            type="password"
          ...
          <button
            type="submit"
            className=" bg-main sm:text-white sm:bg-[#133221] text-[#FFFFFF] bg-[#fa453c] rounded-lg sm:w-52 lg:w-60 w-60 sm:text-md lg:text-lg text-lg font-medium transition-all duration-500 ease-linear transform hover:scale-110 font-Coustard py-1 mt-6 mx-auto"
          >
            Create Account
          </button>
        </form>
